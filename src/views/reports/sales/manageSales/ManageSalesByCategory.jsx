...
const ManageSalesByCategory = () => {
  ...
  const options = allCategory?.result?.map((product) => {
          ...
          <CCard className="mb-4">
            ...
            >
              <CForm onSubmit={handleSubmit(handleSearchProduct)}>
                <CCol xs={4}>
                  <p className="mb-0">Select Categories</p>
                  <Controller
                    control={control}
                    name={"product"}
                    rules={{
                    ...
                    render={({ field: { onChange, value, name, ref } }) => (
                      <Select
                        className="mt-2"
                        placeholder={<div>Type to add categories</div>}
                        inputRef={ref}
                        options={options}
...
export default ManageSalesByCategory;
