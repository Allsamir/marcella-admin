...
import { useGetAllProductQuery } from "../../../../redux/products/productsApi";
...
const ManageSalesByProduct = () => {
    const [selectValue, setSelectValue] = useState("Month");
    const [selectedLabel, setSelectedLabel] = useState(months);
    const monthData = [40, 20, 12, 39, 10, 40, 39, 50, 40, 39, 80, 30];
    ...
    const dayData = [
        40, 20, 12, 39, 10, 40, 39, 80, 40, 39, 80, 40, 40, 20, 12, 39, 10, 40, 39, 80, 40, 39, 80,
        40, 40, 20, 12, 39, 10, 40, 39,
    ];
    ...
    const options = allProduct?.result?.data?.map((product) => {
                                    ...
                                    <Controller
                                        ...
                                        render={({ field: { onChange, value, name, ref } }) => (
                                            <Select
                                                className="mt-2"
                                                placeholder={
                                                    <div>Type to see product information</div>
                                                }
                                                inputRef={ref}
                                                options={options}
                                                value={options?.find(
...
export default ManageSalesByProduct;
